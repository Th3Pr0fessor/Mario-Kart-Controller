...
export type Spring = {
	...
	Is: (any?) -> boolean,
	Compound: (num: number, any?) -> {},
	Calculate: (desiredLength: number, raycastDistance: number, deltaTime: number) -> number,

	_shouldClamp: (before: number, after: number, err: number) -> number,
}
